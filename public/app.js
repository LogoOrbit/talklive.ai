...
const MIC_ON_PATH = 'M12 14c1.66 0 3-1.34 3-3V5c0-1.66-1.34-3-3-3S9 3.34 9 5v6c0 1.66 1.34 3 3 3zm5-3c0 2.76-2.24 5-5 5s-5-2.24-5-5H5c0 3.53 2.61 6.43 6 6.92V21h2v-3.08c3.39-.49 6-3.39 6-6.92h-2z';
...
muteBtn.addEventListener('click', () => {
  ...
  muteIcon.querySelector('path').setAttribute('d', isMuted ? MIC_OFF_PATH : MIC_ON_PATH);
...
socket.on('matched', async ({ initiator, partner, rematched }) => {
  ...
  if (isMuted) {
    ...
    muteIcon.querySelector('path').setAttribute('d', MIC_ON_PATH);
