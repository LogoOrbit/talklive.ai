...
const I18N_STRINGS = {
  en: {
    ...
    "heroSub": "Anonymous \u00b7 worldwide \u00b7 free",
    "logInOrSignUp": "Log in or sign up",
    "gateHint": "Answer steps 1 and 2 above to start.",
    "gateHintGender": "Pick who you are in step 1 to start.",
    "gateHintAnimal": "Pick a spirit animal in step 2 to start.",
    "showAllAnimals": "Show all animals",
    "showFewerAnimals": "Show fewer animals",
    "waitingOnYou": "Waiting on you",
    "youAsked": "You asked",
    "noSentRequests": "You have not sent any requests.",
    "catBilling": "Coins & Billing",
    "growthShareTitle": "Bring more people online",
    "growthShareSub": "Invite a friend to TalkLive",
    ...
    "save": "Save",
    "clear": "Clear",
    "tapToTalk": "Start voice call",
    "startAria": "Start a call with a random person",
    "tapToChat": "Start text chat",
    ...
    // later definition wins - so the call list spent its life describing the
    // text-chat list. The two lists say two different things; they get two keys.
