...
const I18N_STRINGS = Object.assign(window.I18N_STRINGS || {}, {
  en: {
    ...
    "referralRewardToast": "+{days} days of Plus - thanks!",
    ...
    "authLoginSub": "Log in to pick up your friends, chats and name on any device.",
    "authSignupTitle": "Create your account",
    "authSignupSub": "Free, and it takes seconds. Keep your friends and name on every device.",
    "authForgotTitle": "Reset your password",
    "authForgotSub": "We will email you a 6-digit code to set a new one.",
    "authAsideTitle": "Talk to the world. Keep the people you meet.",
    "authPerkFriends": "Your friends and chats, saved",
    "authPerkDevices": "Same name and avatar on every device",
    "authPerkCall": "Call people you met, any time",
    "authBackHome": "Back to TalkLive",
    "authNoAccount": "New to TalkLive?",
    "authCreateOne": "Create an account",
    "authHaveAccount": "Already have an account?",
    "authLegal": "By continuing you agree to our",
    "authTakingHome": "Taking you home…",
    ...
    "confirmLogoutText": "You can log back in any time. Your friends and chats stay with your account.",
    ...
    "friendIdLinkCopied": "Link copied",
    "friendIdCopied": "ID copied",
    ...
    "filtersTrimmedFree": "Gender & extra countries need Plus",
    ...
    "callbackLaterSent": "Call request sent to {name}",
    "friendIdGuest": "Guest",
    ...
    "dmGateRequest": "Send {name} a friend request to message them. You can send one message until they accept.",
    "dmGateOne": "Friend request sent. You can send {name} one message until they accept.",
    "dmGateWaiting": "Message sent. You can send more once {name} accepts your friend request.",
    "dmGateAccept": "{name} wants to be friends. Accept to reply.",
    "dmGateAddBtn": "Send friend request",
    "dmGateAcceptBtn": "Accept",
    "dmGateDeclineBtn": "Decline",
    "errDmRequestFirst": "Send a friend request before messaging someone who isn't your friend.",
    "errDmAwaitingAccept": "You can send more messages once they accept your friend request.",
    "errDmAcceptFirst": "Accept their friend request to reply.",
    ...
    "chatQuietTitle": "It's quiet right now",
    "chatQuietBody": "Keep this open - you'll be matched the moment someone arrives. One more person online is all it takes.",
    ...
    "nicknameShown": "Display name (shown to others)",
    ...
    "updateNickname": "Update Display Name",
    ...
    "acceptCallsOn": "Calls on",
    "acceptCallsOff": "Calls off",
    ...
    "callbackAway": "They're texting - we've let them know",
    "callbackBusyQueued": "They're on a call - we've let them know",
    ...
    "safetyLink": "Safety",
    "statusNicknameUpdated": "Display name updated.",
    "myProfile": "My profile",
    "allSettings": "All settings",
    "moreProfileSettings": "More profile settings",
    ...
    "nickTooShort": "Display name needs at least 2 letters or numbers.",
    "nickTooLong": "Display name can be at most 20 characters.",
    ...
    "notifyDoneToast": "We'll notify you when it's live",
    "notifyNotedToast": "Thanks - noted!",
    "notifyShopFoot": "Be the first to know when it goes live.",
    "helpSupport": "Help & Support",
    "animals": "Animals",
    "animalShort": "Animal",
    "autoConnectTitle": "Auto-connect",
    "autoConnectOnToast": "Auto-connect on",
    ...
    "callSwitchOutText": "You are on a call. Calling {name} will end it.",
    ...
    "partnerLocalTime": "{time} their time",
    "partnerTimeAhead": "{diff} ahead of you",
    "partnerTimeBehind": "{diff} behind you",
    "partnerTimeSame": "same time as you",
    ...
    "callbackNoAnswer": "No answer - they'll see you called",
    ...
    "accept": "Accept",
    "acceptFriendFrom": "Accept friend request from {name}",
    "decline": "Decline",
    "justNow": "just now",
    "minAgo": "{n}m ago",
    "hourAgo": "{n}h ago",
