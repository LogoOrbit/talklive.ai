...
| `ADSTERRA_API_KEY` | Adsterra Publisher API token (Adsterra → Profile → API). Shows ad revenue by day, ad unit and country on the owner dashboard's Revenue tab. Optional |
